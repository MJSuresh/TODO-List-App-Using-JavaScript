...
function checkbox_function(check_task) {
    ...
    if (document.querySelector(".active").id == "Completed" || (check_task.firstChild.style.backgroundColor == "green" &&
...
function delete_function(delete_task) {
    ...
    if (
        ...
        confirm_message = `Are you sure want to delete the TASK?\n\n`;
        confirmFunction(confirm_message, shortened, function (result) {
            if (result) {
